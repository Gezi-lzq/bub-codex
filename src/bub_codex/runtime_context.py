...
class RuntimeContextKernel:
        ...
        *,
        ...
        if resolution.action == "resume_thread":
            ...
            try:
                ...
                await self.tape_store.append(diagnostic)
                raise
        ...
        if resolution.action == "create_anchor":
            ...
            await self.tape_store.append_many(anchor_events)
            return await self._materialize_from_latest_anchor(
    ...
    async def _materialize_from_latest_anchor(
        self,
        *,
        ...
        try:
            ...
            await self.tape_store.append_many(failed_events)
            return RuntimeStartResult(
        ...
        await self.tape_store.append_many((materialized_event, bound_event))
        return RuntimeStartResult(
            status=status,
            resolution=resolution,
            anchor_id=anchor_id,
